    ...
    let have :: Config
        have = Config
          ...
          , _cfgIdPs =
            [ IdPConfig
              { _idpPath       = "azure-test"
              , _idpIssuerID   = unsafeParseURI "https://sts.windows.net/682febe8-021b-4fde-ac09-e60085f05181/"
              , _idpRequestUrl = unsafeParseURI "https://login.microsoftonline.com/682febe8-021b-4fde-ac09-e60085f05181/saml2"
