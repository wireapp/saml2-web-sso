...
microsoft_authnrequest_1 = AuthnRequest {_rqID = ID {renderID = "id6c1c178c166d486687be4aaf5e482730"}, _rqVersion = Version_2_0, _rqIssueInstant = unsafeReadTime "2013-03-18T03:28:54.1839884Z", _rqIssuer = mkIssuer "https://www.contoso.com"}
...
onelogin_request_1 = AuthnRequest
  ...
  , _rqIssuer = mkIssuer "http://sp.example.com/demo1/metadata.php"
  }
